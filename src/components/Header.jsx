...
export default function Header({ myId, setShowFeedbackOverlay }) {
  ...
  return (
    <header className={isMobile ? `hidden md:flex w-full p-4 items-center justify-between bg-white shadow`: `py-2 px-4 backdrop-blur-xs bg-white/20 flex justify-between items-center`}>

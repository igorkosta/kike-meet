...
export default function MeetingInfo({ meetingUrl, copyMeetingLink }) {
  return (
    <>
      <div className="absolute bottom-24 left-4 bg-neutral-800/80 backdrop-blur-md rounded-xl p-4 flex flex-col gap-2 text-sm shadow-lg w-72 border border-neutral-700">
        <h2 className="text-base font-semibold text-neutral-200">Meeting ready</h2>
